...
{
    public class Srl : MipsInstruction
    {
        public override string Name => "Shift right logical";
        ...
        public override string Syntax => "srl $d, $t, h";
        public override string Encoding => "0000 00-- ---t tttt dddd dhhh hh00 0010";
    }
}